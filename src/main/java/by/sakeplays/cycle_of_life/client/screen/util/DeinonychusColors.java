...
public class DeinonychusColors {
    ...
    public static final List<ColorOption> BELLY
            = List.of(
            new ColorOption(170, 201, 216, 1f, 0.5f),
    ...
    public static final List<ColorOption> MALE_DISPLAY
            = List.of(
            new ColorOption(255, 101, 89, 1f, 0.3f),
            new ColorOption(156, 236, 139, 1f, 0.3f),
            new ColorOption(154, 132, 200, 1f, 0.3f),
