...
public enum Dinosaurs {
    ...
    NONE(0, 0f,0f, 0f, 1f, 0f, 0f,
            ...
            GrowthCurve.DEINONYCHUS_CURVE, 0, 20),
    ...
    PACHYCEPHALOSAURUS(5, 0.12f,0.55f, 0.003f, 425f, 3f, 4f,
            ...
            0.5f, GrowthCurve.PACHY_CURVE, 30, 55),
    ...
    DEINONYCHUS(5, 0.14f,0.67f,0.005f,75f, 5f, 12f,
            ...
            0.75f, GrowthCurve.DEINONYCHUS_CURVE, 50, 20),
    ...
    PTERANODON(4, 0.07f,0.25f, 0.08f, 40f, 3f, 4f,
            ...
            0.6f, GrowthCurve.DEINONYCHUS_CURVE, 30, 20),
    ...
    UTAHRAPTOR(5, 0.18f,0.61f, 0.08f, 225f, 3f, 4f,
            ...
            0.85f, GrowthCurve.DEINONYCHUS_CURVE, 30, 20);
    ...
    Dinosaurs(int maxEggs, float walkSpeed, float sprintSpeed, float growthPerMin, float weight, float heatResistance, float coldResistance, float turnSpeed,
              ...
              float healthRegen, int ID, float jumpStrength, GrowthCurve growthCurve, int eatingTime, float grabPartition) {
